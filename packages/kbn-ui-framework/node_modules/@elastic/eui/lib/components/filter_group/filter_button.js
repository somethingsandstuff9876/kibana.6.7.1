...
var EuiFilterButton = function EuiFilterButton(_ref) {
  var children = _ref.children,
      ...
      type = _ref.type,
      rest = _objectWithoutProperties(_ref, ['children', 'className', 'iconType', 'iconSide', 'color', 'hasActiveFilters', 'isDisabled', 'isSelected', 'href', 'target', 'rel', 'onClick', 'type']);
...
EuiFilterButton.__docgenInfo = [{
  ...
  'props': {
    ...
    'onClick': {
      ...
      'required': false,
      'description': 'Onclick should not be comibned with href'
    },
    'type': {
      'type': {
        'name': 'string'
