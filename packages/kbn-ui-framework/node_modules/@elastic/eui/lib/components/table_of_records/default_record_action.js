...
exports.DefaultRecordAction = undefined;
...
var DefaultRecordAction = exports.DefaultRecordAction = function (_React$Component) {
  _inherits(DefaultRecordAction, _React$Component);

  function DefaultRecordAction(props) {
    _classCallCheck(this, DefaultRecordAction);

    var _this = _possibleConstructorReturn(this, (DefaultRecordAction.__proto__ || Object.getPrototypeOf(DefaultRecordAction)).call(this, props));
  ...
  _createClass(DefaultRecordAction, [{
    ...
    value: function render() {
      ...
      var onClick = function onClick() {
        return action.onClick(record, model);
      };
    ...
    value: function resolveActionIcon() {
      ...
      if (action.icon) {
        return (0, _predicate.isString)(action.icon) ? action.icon : action.icon(record, model);
      }
    }
  }, {
    ...
    value: function resolveActionColor() {
      ...
      if (action.color) {
        return (0, _predicate.isString)(action.color) ? action.color : action.color(record, model);
      }
      return defaults.color;
    }
  }]);

  return DefaultRecordAction;
}(_react2.default.Component);

DefaultRecordAction.__docgenInfo = [{
  'description': '',
  'displayName': 'DefaultRecordAction',
  'methods': [{
    'name': 'onFocus',
    'docblock': null,
    'modifiers': [],
