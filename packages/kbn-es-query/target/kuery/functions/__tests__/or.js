  ...
  describe('or', function () {
    ...
    describe('buildNodeParams', function () {
      ...
      it('arguments should contain the unmodified child nodes', function () {
        var result = or.buildNodeParams([childNode1, childNode2]);
    ...
    describe('toElasticsearchQuery', function () {
      ...
      it('should wrap subqueries in an ES bool query\'s should clause', function () {
        var node = _node_types.nodeTypes.function.buildNode('or', [childNode1, childNode2]);
        var result = or.toElasticsearchQuery(node, indexPattern);
        (0, _expect2.default)(result).to.only.have.keys('bool');
        (0, _expect2.default)(result.bool).to.have.keys('should');
        (0, _expect2.default)(result.bool.should).to.eql([childNode1, childNode2].map(function (childNode) {
      ...
      it('should require one of the clauses to match', function () {
        var node = _node_types.nodeTypes.function.buildNode('or', [childNode1, childNode2]);
        var result = or.toElasticsearchQuery(node, indexPattern);
        (0, _expect2.default)(result.bool).to.have.property('minimum_should_match', 1);
      });
    });
  });
});