...
var SchemaFromExport = /** @class */ (function () {
    ...
    SchemaFromExport.prototype.handle = function (file, _cliOptions) {
        var _this = this;
        spinner_1.default.info("Loading GraphQL schema object, text, ast, or introspection json from JavaScript ES6 export: " + file + "...");
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 8:
                        reject(new Error("\n                  Invalid export from file: " + fullPath + "\n                  Use either " + chalk_1.default.bold('default export') + " or export " + chalk_1.default.bold('schema') + " variable.\n\n                  Example:\n\n                    export default ...;\n\n                    OR\n\n                    export const schema = ...;\n\n                "));
                        _a.label = 9;
