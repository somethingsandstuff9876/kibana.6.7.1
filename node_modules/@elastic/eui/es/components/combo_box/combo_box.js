...
function (_Component) {
  ...
  function EuiComboBox(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onContainerBlur", function (e) {
      ...
      if (!_this.hasActiveOption() && !focusedInInput && !focusedInOptionsList) {
  ...
  _createClass(EuiComboBox, [{
    ...
    value: function render() {
      var _this$props7 = this.props,
          ...
          rest = _objectWithoutProperties(_this$props7, ["id", "isDisabled", "className", "isLoading", "options", "selectedOptions", "onCreateOption", "placeholder", "noSuggestions", "renderOption", "singleSelection", "onChange", "onSearchChange", "async", "isInvalid", "rowHeight", "isClearable", "fullWidth", "compressed", "data-test-subj"]);
