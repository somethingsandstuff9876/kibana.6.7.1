...
function (_Component) {
  ...
  _createClass(EuiBasicTable, [{
    ...
    value: function renderTable() {
      ...
      var mobileHeader = responsive ? _react.default.createElement(_table_header_mobile.EuiTableHeaderMobile, null, this.renderTableMobileSort()) : undefined;
    ...
    value: function renderItemCell(item, column, key, content) {
      ...
      var cellProps = getCellProps(item, column, cellPropsCallback); // Name can also be an array or an element, so we need to convert it to undefined. We can't
      ...
      var header = typeof name === 'string' ? name : undefined;
