...
export var findTestSubject = function findTestSubject(mountedComponent, testSubjectSelector) {
  var testSubject = mountedComponent.find("[data-test-subj=\"".concat(testSubjectSelector, "\"]")); // Restores Enzyme 2's find behavior, which was to only return ReactWrappers around DOM elements.
