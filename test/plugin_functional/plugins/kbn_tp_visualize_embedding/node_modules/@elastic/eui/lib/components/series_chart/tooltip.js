...
function Tooltip(_ref) {
  ...
  if (_lodash.default.isEmpty(tooltipPoints)) {
    return null;
  }

  return _react.default.createElement(_reactVis.Hint, _extends({}, props, {
    value: {
      x: x,
      y: y
    }
...
Tooltip.propTypes = {
  ...
  tooltipPoints: _propTypes.default.array.isRequired,
