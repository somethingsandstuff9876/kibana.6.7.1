...
export var EuiTableHeaderCell = function EuiTableHeaderCell(_ref) {
  var children = _ref.children,
      ...
      rest = _objectWithoutProperties(_ref, ["children", "align", "onSort", "isSorted", "isSortAscending", "className", "scope", "isMobileHeader", "hideForMobile"]);
  ...
  if (onSort) {
    ...
    }), React.createElement(EuiScreenReaderOnly, null, React.createElement("span", null, "Click to sort in ".concat(ariaSortValue === 'descending' || 'none' ? 'ascending' : 'descending', " order"))))));
  }
