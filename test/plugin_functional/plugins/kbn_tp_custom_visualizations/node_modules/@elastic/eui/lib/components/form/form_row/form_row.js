  ...
  _createClass(EuiFormRow, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          rest = _objectWithoutProperties(_this$props, ["children", "helpText", "isInvalid", "error", "label", "hasEmptyLabelSpace", "fullWidth", "className", "describedByIds", "compressed"]);
      ...
      if (label) {
        optionalLabel = _react.default.createElement(_form_label.EuiFormLabel, {
      ...
      var field = (0, _react.cloneElement)(children, _objectSpread({
        id: id,
